...
<!DOCTYPE html>
    ...
    <head>
        ...
        $pro_id = $_GET["pro_id"];
        $requete = "SELECT * FROM produits join categories on cat_id = pro_cat_id WHERE pro_id=".$pro_id; //concatenation differente en sql si l'element concaténé est une chaine, voir scrit ajout et modif
    ...
    <body> 
        <div class="container"> <!--container global de la page-->
            ...
            <div class="d-flex justify-content-center" name = actionProduit>
                <a  class="btn" href="modification.php?pro_id=<?=$pro_id;?>"><button class="btn-success">Modifier</button></a>
              
                <a  class="btn" href="supprime.php?pro_id=<?=$pro_id;?>"><button class="btn-primary">Supprimer</button></a>
                
                <a  class="btn" href="tableauadmin.php"><button class="btn-secondary">Retour</button></a>
            </div>
